...
export const ALL_CONTENT: ContentItem[] = [
  ...
  /* ── Animes (TMDB primary, SVG fallback guaranteed to render) ── */
  { id: 25, title: "Demon Slayer",                   type: "Anime",        rating: 4.8, badges: ["Leg","Libras"],         platforms: ["crunchyroll","netflix"], perfect: false, posterColor: "#ec4899", poster: `${B}/wrCVHdkBlBWdJUZPvnJWcBRuhSY.jpg`, fallbackPoster: gamePoster({ title: "Demon Slayer",        studio: "ufotable",      year: 2019, colors: ["#dc2626","#450a0a"], glyph: "⚔" }) },
  { id: 26, title: "Spy x Family",                   type: "Anime",        rating: 4.7, badges: ["Leg","Adapt"],          platforms: ["crunchyroll"],           perfect: false, posterColor: "#10b981", poster: `${B}/qFD4mzNGsbT7s2sxk6S9TfgM52u.jpg`, fallbackPoster: gamePoster({ title: "Spy x Family",        studio: "Wit Studio",    year: 2022, colors: ["#10b981","#064e3b"], glyph: "🕵" }) },
  { id: 27, title: "Frieren: Beyond Journey's End",  type: "Anime",        rating: 4.9, badges: ["Leg","Libras","Adapt"], platforms: ["crunchyroll"],           perfect: true,  posterColor: "#7c3aed", poster: `${B}/dqZENchTd7lp5zht7BdlqM7RBhD.jpg`, fallbackPoster: gamePoster({ title: "Frieren",             studio: "Madhouse",      year: 2023, colors: ["#a855f7","#1e1b4b"], glyph: "🌿" }) },
  { id: 28, title: "Cyberpunk: Edgerunners",         type: "Anime",        rating: 4.8, badges: ["AD","Leg","Libras"],    platforms: ["netflix"],               perfect: true,  posterColor: "#facc15", poster: `${B}/h4VB6m0RwcicVEZvzftYZyKXs6K.jpg`, fallbackPoster: gamePoster({ title: "Cyberpunk Edgerunners", studio: "Trigger",      year: 2022, colors: ["#facc15","#7c2d12"], glyph: "⚡" }) },

  /* ── Documentários ── */
  { id: 29, title: "13th",                           type: "Documentário", rating: 4.9, badges: ["AD","Leg","Libras","Adapt"], platforms: ["netflix"],          perfect: true,  posterColor: "#1f2937", poster: `${B}/dXVo9eW4qvF3rNbJSPb1VfhKnHl.jpg`, fallbackPoster: gamePoster({ title: "13th",                 studio: "Ava DuVernay",  year: 2016, colors: ["#1f2937","#000"     ], glyph: "⚖" }) },
  { id: 30, title: "My Octopus Teacher",             type: "Documentário", rating: 4.7, badges: ["AD","Leg","Libras"],    platforms: ["netflix"],               perfect: true,  posterColor: "#0891b2", poster: `${B}/8mfYUNzlH9eY1Q83lLqA0tFI5HZ.jpg`, fallbackPoster: gamePoster({ title: "My Octopus Teacher",  studio: "Pippa Ehrlich",  year: 2020, colors: ["#0891b2","#083344"], glyph: "🐙" }) },
  { id: 31, title: "Planeta Terra III",              type: "Documentário", rating: 4.8, badges: ["AD","Leg","Libras"],    platforms: ["globoplay","hbomax"],    perfect: true,  posterColor: "#16a34a", poster: `${B}/aoH7nxn1lLwLwl2ddCkahnpevh8.jpg`, fallbackPoster: gamePoster({ title: "Planeta Terra III",    studio: "BBC Studios",   year: 2023, colors: ["#16a34a","#064e3b"], glyph: "🌍" }) },
  { id: 32, title: "Won't You Be My Neighbor?",      type: "Documentário", rating: 4.6, badges: ["AD","Leg","Adapt"],     platforms: ["prime"],                 perfect: false, posterColor: "#ef4444", poster: `${B}/lqXq0jrTYRsKklIBfXKj42pRJsI.jpg`, fallbackPoster: gamePoster({ title: "Mister Rogers",        studio: "Focus Features", year: 2018, colors: ["#ef4444","#7f1d1d"], glyph: "💗" }) },
];
